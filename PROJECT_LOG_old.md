...
Philosophy: Zero copy-paste. High visual impact (Dark AI Theme). Automated scouting via Gemini 3 Flash.
...
- Created **Live Scouting Logic**:
    ...
    - Selected **Gemini 3 Flash** as the primary summary/author engine (upgraded from 2.0 Flash on 2026-02-07).
