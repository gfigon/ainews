...
- **Full open stack**: Code, weights, training pipelines — all available on [GitHubhttps://github.com/bytedance/Protenix){rel="nofollow"}{rel="nofollow"}
...
The model is available at [protenix-server.comhttps://protenix-server.com/login){rel="nofollow"}{rel="nofollow"}, with the full stack on [GitHubhttps://github.com/bytedance/Protenix){rel="nofollow"}{rel="nofollow"}.
