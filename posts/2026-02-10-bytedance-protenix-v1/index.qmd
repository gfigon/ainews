...
- **Full open stack**: Code, weights, training pipelines — all available on [GitHub](https://github.com/bytedance/Protenix){rel="nofollow"}{rel="nofollow"}
...
The model is available at [protenix-server.com](https://protenix-server.com/login){rel="nofollow"}{rel="nofollow"}, with the full stack on [GitHub](https://github.com/bytedance/Protenix){rel="nofollow"}{rel="nofollow"}.
