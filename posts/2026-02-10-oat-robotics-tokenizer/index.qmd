...
The code and paper are available on [GitHub](https://github.com/Chaoqi-LIU/oat) and [arXiv](https://arxiv.org/abs/2602.04215).

---

*Signal over noise. Subscribe to [Robo AI Digest](https://roboaidigest.com).*
