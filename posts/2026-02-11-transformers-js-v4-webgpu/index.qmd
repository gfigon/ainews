...
The tokenization logic is now available as a separate [@huggingface/tokenizers](https://www.npmjs.com/package/@huggingface/tokenizers){rel="nofollow"}{rel="nofollow"} library — just 8.8kB gzipped with zero dependencies.
...
Install the preview with `npm i @huggingface/transformers@next` and explore examples at the [Transformers.js repository](https://github.com/xenova/transformers.js){rel="nofollow"}{rel="nofollow"}.
