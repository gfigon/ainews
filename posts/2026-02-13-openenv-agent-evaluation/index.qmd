...
For those looking to dive deeper into the technical evaluation metrics, the [OpenEnv repository](https://github.com/meta-pytorch/OpenEnv){rel="nofollow"} and the [Calendar Gym](https://huggingface.co/spaces/TuringEnterprises/calendar-gym){rel="nofollow"} are now available for community testing and expansion.

***

*Source: [Hugging Face Blog](https://huggingface.co/blog/openenv-turing){rel="nofollow"} (Nofollow)*
