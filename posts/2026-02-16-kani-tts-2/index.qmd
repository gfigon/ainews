...
4. **AI Tools & Frameworks**: Apache 2.0 licensing means commercial integration is straightforward.

Kani-TTS-2 is available on Hugging Face in both [English (EN)](https://huggingface.co/nineninesix/kani-tts-2-en){rel="nofollow"} and [Portuguese (PT)](https://huggingface.co/nineninesix/kani-tts-2-pt){rel="nofollow"} versions.
