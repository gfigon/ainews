...
The model is available on [Hugging Face](https://huggingface.co/collections/Qwen/qwen35){rel="nofollow"} with full technical details on the [Qwen blog](https://qwen.ai/blog?id=qwen3.5){rel="nofollow"}.
