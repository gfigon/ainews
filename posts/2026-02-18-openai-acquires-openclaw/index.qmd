...
In his [blog post announcing the movehttps://steipete.me/posts/2026/openclaw){rel="nofollow"} to OpenAI, Steinberger framed the decision in characteristically understated terms. He acknowledged the project could have become "a huge company" but said that wasn't what interested him. Instead, he wrote that his next mission is to **"build an agent that even my mum can use"** — a goal he believes requires access to frontier models and research that only a major lab can provide.
